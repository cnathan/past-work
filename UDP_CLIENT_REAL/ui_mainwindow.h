...
**
** Created: Thu Apr 15 15:18:29 2010
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(551, 502);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QString::fromUtf8("centralWidget"));
        lineEdit_2 = new QLineEdit(centralWidget);
        lineEdit_2->setObjectName(QString::fromUtf8("lineEdit_2"));
        lineEdit_2->setEnabled(false);
        lineEdit_2->setGeometry(QRect(180, 390, 151, 20));
        QFont font;
        font.setBold(true);
        font.setWeight(75);
        ...
        insert->setGeometry(QRect(10, 349, 391, 21));
        ...
        IP_ADDRESS->setGeometry(QRect(200, 410, 113, 20));
        lineEdit_4 = new QLineEdit(centralWidget);
        lineEdit_4->setObjectName(QString::fromUtf8("lineEdit_4"));
        lineEdit_4->setEnabled(false);
        lineEdit_4->setGeometry(QRect(10, 0, 531, 20));
        QFont font1;
        ...
        list->setGeometry(QRect(10, 30, 531, 321));
        ...
        Send->setGeometry(QRect(400, 349, 141, 23));
        Connect = new QPushButton(centralWidget);
        Connect->setObjectName(QString::fromUtf8("Connect"));
        Connect->setGeometry(QRect(360, 410, 131, 23));
        UserName = new QLineEdit(centralWidget);
        UserName->setObjectName(QString::fromUtf8("UserName"));
        UserName->setGeometry(QRect(20, 410, 113, 20));
        lineEdit_3 = new QLineEdit(centralWidget);
        lineEdit_3->setObjectName(QString::fromUtf8("lineEdit_3"));
        lineEdit_3->setEnabled(false);
        lineEdit_3->setGeometry(QRect(0, 390, 151, 20));
        ...
        menuECE469_UDP_Client = new QMenu(menuBar);
        menuECE469_UDP_Client->setObjectName(QString::fromUtf8("menuECE469_UDP_Client"));
        ...
        menuBar->addAction(menuECE469_UDP_Client->menuAction());
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit_4->setText(QApplication::translate("MainWindow", "ECE469 UDP Client ", 0, QApplication::UnicodeUTF8));
        ...
        menuECE469_UDP_Client->setTitle(QApplication::translate("MainWindow", "ECE469 UDP Client ", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
