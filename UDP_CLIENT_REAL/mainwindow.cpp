    ...
    QMainWindow(parent)
{
    ...
    connect(&UdpSocket, SIGNAL(readyRead()), this, SLOT(addtext()));
}
...
void MainWindow::SendClicked()
{
    ...
    strcat(SndPkt,")- ");
    strcat(SndPkt,input);
    UdpSocket.write(SndPkt,strlen(SndPkt));
...
void MainWindow::addtext()
{
    ...
    bytes_recv=UdpSocket.read(RcvPkt, UdpSocket.bytesAvailable());
    time (&rawtime);
    timeinfo = localtime (&rawtime);
